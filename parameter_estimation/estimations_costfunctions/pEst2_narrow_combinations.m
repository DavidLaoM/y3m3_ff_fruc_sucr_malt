...
nref = 14;
selSims = [5,14]; % manual
% % selSims = [1,14]; % c1 control works
% % selSims = [2:4,14]; % c2 ref ald
% % selSims = [5:7,14]; % c4 ref gapdh
% % selSims = [8:10,14]; % c6 ref ald tre
% % selSims = [11:13,14]; % c7 ref gapdh tre
plot_all_loop
% plot_all
