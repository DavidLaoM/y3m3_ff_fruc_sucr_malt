...
% case 1. tre
saveNames{1} = 'pE3_par1tre_all.mat';
saveNames{2} = 'pE3_par1tre_fructose.mat';
saveNames{3} = 'pE3_par1tre_sucrose.mat';
saveNames{4} = 'pE3_par1tre_maltose.mat';
% case 2. tre + ref
saveNames{5} = 'pE3_par2tre_ref_all.mat';
saveNames{6} = 'pE3_par2tre_ref_fructose.mat';
saveNames{7} = 'pE3_par2tre_ref_sucrose.mat';
saveNames{8} = 'pE3_par2tre_ref_maltose.mat';
% case 3. tre + ref + gapdh
saveNames{9} = 'pE3_par3tre_ref_gapdh_all.mat';
saveNames{10} = 'pE3_par3tre_ref_gapdh_fructose.mat';
saveNames{11} = 'pE3_par3tre_ref_gapdh_sucrose.mat';
saveNames{12} = 'pE3_par3tre_ref_gapdh_maltose.mat';
...
% 
parSet1 = parTRE;
parSet2 = [par_ref, parTRE];
parSet3 = [par_ref, parGAPDH, parTRE];
...
% case 2. tre + ref
parCombs{5} = parSet2; %'pE3_par2tre_ref_all.mat';
parCombs{6} = parSet2; %'pE3_par2tre_ref_fructose.mat';
parCombs{7} = parSet2; %'pE3_par2tre_ref_sucrose.mat';
parCombs{8} = parSet2; %'pE3_par2tre_ref_maltose.mat';
% case 3. tre + ref + gapdh
parCombs{9} = parSet3; %'pE3_par3tre_ref_gapdh_all.mat';
parCombs{10} = parSet3; %'pE3_par3tre_ref_gapdh_fructose.mat';
parCombs{11} = parSet3; %'pE3_par3tre_ref_gapdh_sucrose.mat';
parCombs{12} = parSet3; %'pE3_par3tre_ref_gapdh_maltose.mat';
...
% case 2. tre + ref
warray{5}([201 206 209 203 220 203,    301 302 307 310 304 320 304,    401 406 409 403 420 403]) = ones; %'pE3_par2tre_ref_all.mat';
warray{6}([201 206 209 203 220 203]) = ones; %'pE3_par2tre_ref_fructose.mat';
warray{7}([301 302 307 310 304 320 304]) = ones; %'pE3_par2tre_ref_sucrose.mat';
warray{8}([401 406 409 403 420 403]) = ones; %'pE3_par2tre_ref_maltose.mat';
% case 3. tre + ref + gapdh
warray{9}([201 206 209 203 220 208 207 203,    301 302 307 310 304 320 309 308 304,    401 406 409 403 420 408 407 403]) = ones; %'pE3_par3tre_ref_gapdh_all.mat';
warray{10}([201 206 209 203 220 208 207 203]) = ones; %'pE3_par3tre_ref_gapdh_fructose.mat';
warray{11}([301 302 307 310 304 320 309 308 304]) = ones; %'pE3_par3tre_ref_gapdh_sucrose.mat';
warray{12}([401 406 409 403 420 408 407 403]) = ones; %'pE3_par3tre_ref_gapdh_maltose.mat';
...
fh7 = figure(7);
% 
pE3_exp_fruc = fh3.Children(20).Children(2).YData;
pE3_exp_sucr = fh5.Children(20).Children(2).YData;
pE3_exp_malt = fh7.Children(20).Children(2).YData;
% 
pE3_ref_fruc = interp1(fh3.Children(20).Children(3).XData,...
    fh3.Children(20).Children(3).YData,...
    fh3.Children(20).Children(2).XData, ...
    'pchip');
pE3_ref_sucr = interp1(fh5.Children(20).Children(3).XData,...
    fh5.Children(20).Children(3).YData,...
    fh5.Children(20).Children(2).XData, ...
    'pchip');
pE3_ref_malt = interp1(fh7.Children(20).Children(3).XData,...
    fh7.Children(20).Children(3).YData,...
    fh7.Children(20).Children(2).XData, ...
    'pchip');
% 
pE3_pgm1_tps1_fruc = interp1(fh3.Children(20).Children(6).XData,...
    fh3.Children(20).Children(6).YData,...
    fh3.Children(20).Children(2).XData, ...
    'pchip');
pE3_pgm1_tps1_sucr = interp1(fh5.Children(20).Children(5).XData,...
    fh5.Children(20).Children(5).YData,...
    fh5.Children(20).Children(2).XData, ...
    'pchip');
pE3_pgm1_tps1_malt = interp1(fh7.Children(20).Children(4).XData,...
...
% % % 
% % % figure
% % % subplot(1,4,1),plot(fh3.Children(20).Children(4).XData,fh3.Children(20).Children(4).YData), title('4')
% % % subplot(1,4,2),plot(fh3.Children(20).Children(5).XData,fh3.Children(20).Children(5).YData), title('5')
% % % subplot(1,4,3),plot(fh3.Children(20).Children(6).XData,fh3.Children(20).Children(6).YData), title('6')
% % % subplot(1,4,4),plot(fh3.Children(20).Children(7).XData,fh3.Children(20).Children(7).YData), title('7')
% % 
% % figure
% % subplot(1,4,1),plot(fh5.Children(20).Children(4).XData,fh5.Children(20).Children(4).YData), title('4')
% % subplot(1,4,2),plot(fh5.Children(20).Children(5).XData,fh5.Children(20).Children(5).YData), title('5')
% % subplot(1,4,3),plot(fh5.Children(20).Children(6).XData,fh5.Children(20).Children(6).YData), title('6')
% % subplot(1,4,4),plot(fh5.Children(20).Children(7).XData,fh5.Children(20).Children(7).YData), title('7')
% 
% figure
% subplot(1,4,1),plot(fh7.Children(20).Children(4).XData,fh7.Children(20).Children(4).YData), title('4')
% subplot(1,4,2),plot(fh7.Children(20).Children(5).XData,fh7.Children(20).Children(5).YData), title('5')
% subplot(1,4,3),plot(fh7.Children(20).Children(6).XData,fh7.Children(20).Children(6).YData), title('6')
% subplot(1,4,4),plot(fh7.Children(20).Children(7).XData,fh7.Children(20).Children(7).YData), title('7')
...
%% save resulting case
x_fit_all = xAll(1,:);
x_fit_fructose = xAll(2,:);
x_fit_sucrose = xAll(3,:);
x_fit_maltose = xAll(4,:);
save('x_Y3M3_4.mat','x_fit_all','x_fit_fructose','x_fit_sucrose','x_fit_maltose')
