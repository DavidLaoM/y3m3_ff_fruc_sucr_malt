function [error,error_gluc,error_fruc,error_sucr,error_malt] = costfun_FF01_all_recall_error_par(x_temp,setup,x,plotflag,selPars,lambda,w)

    % current parameter set
    x(selPars) = x_temp;
    setup.x_reg = x(selPars);
