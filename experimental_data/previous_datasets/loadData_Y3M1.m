...
CanelasData2; canelas.mtlD = canelas_SS.mtlD_original; %adjustment in hte middle of the versions
    ...
    canelas_SS.mtlD.TRE = 1/2*[230.45 166.36 111.36 18.18 3.18 3.18 3.18 3.18];
    canelas_SS.mtlD.qCO2 = 1/2*[0.266990291262136 0.4894822006472497 0.8454692556634313 1.5485436893203888 2.883495145631069 3.221682847896441  3.9959546925566354 5.135113268608415];
    canelas_SS.mtlD.qO2 = 1/2*[0.23264401772525822 0.4420236336779908 0.7644017725258492 1.4158050221565732 1.927621861152142 1.8977104874446087 1.3925406203840474 1.1698670605612997];
    canelas_SS.mtlD.qAcet = 1/2*[0 0 0 0.0013215822670930022 0.006435574102534064 0.032913440158206936 0.11959147491948519 0.18707008545879839];
    canelas_SS.mtlD.qEtoh = 1/2*[0.012376268598816687 0.00036916069126924356 0.006726232934139986 0.007333158138429496 1.0133773823378505 1.3568094505136967 2.436147714332195 3.797531003241106];
    canelas_SS.mtlD.qGlyc = 1/2*[0.0003384615384615375 0.00043076923076922763 0.000676923076923075 0.0011692307692307662 0.0018461538461538446 0.0018461538461538446 0.006984615384615384 0.01716923076923077];
...
canelas_SS.ordered.metabolites.onoff = zeros(1,32);
    ...
    canelas_SS.ordered.metabolites.onoff(32) = 1;% ECglycerol
    canelas_SS.ordered.metabolites.onoff(31) = 1;% ETOH
